            ...
            <aside className="space-y-3">
              <div className="rounded-sm border border-[#e3e3e3] bg-white p-4">
                ...
                <p className="mt-1 text-[12px] text-[#666]">
                  {size} / {condition} /{" "}
                  <span className="text-[#007782]">{brand}</span>
                </p>
                <p className="mt-2 text-[12px] leading-[1.35] text-[#666]">
                  {description}
                </p>

                <div className="mt-4 space-y-0.5 border-b border-[#ececec] pb-3">
                  <p className="text-[22px] font-semibold leading-none text-[#111]">
                    {price}
                  </p>
              ...
              <div className="rounded-sm border border-[#e3e3e3] bg-white">
                ...
                >
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      <h2 className="truncate text-[14px] font-semibold text-[#222]">
                        {toText(seller?.username, "Seller")}
                      </h2>
                      <div className="flex items-center gap-1">
                        <div className="flex text-yellow-400">
                          {[...Array(Math.floor(seller?.rating_avg || 0))].map(
                            (_, i) => (
                ...
                <div className="space-y-2 p-3 text-[12px] text-[#666]">
                  <div className="flex items-center gap-2">
                    ...
                    <span>
                      {toText(seller?.city, "Unknown city")},{" "}
                      {toText(seller?.country, "Unknown country")}
                    </span>
                  </div>
                  <div className="flex items-center gap-2">
                    <Clock size={14} className="text-[#8b8b8b]" />
                    <span>
                      {toText(seller?.lastSeen, "Last seen 10 min ago")}
                    </span>
                  </div>
                </div>
              </div>
