    ...
    <footer className="mt-20 w-full border-t border-gray-200 bg-white pb-8 pt-12">
      <div className="mx-auto max-w-7xl px-4">
        ...
        <div className="flex flex-wrap justify-center md:justify-start gap-x-6 gap-y-2 text-[13px] text-gray-500">
          ...
          <Link href="/account-deletion-policy" className="hover:underline">Account deletion policy</Link>
          ...
          <Link href="/ristricted-prohibited-Policy" className="hover:underline">Ristricted and Prohibited items</Link>
