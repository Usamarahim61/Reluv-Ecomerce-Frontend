...
const ProfilePage = ({ showNavbar = true }: { showNavbar?: boolean }) => {
  ...
  // FIX: Ensure src is never an empty string
  const avatarSrc = userData.avatar?.url && userData.avatar.url !== "" 
    ? userData.avatar.url 
              ...
              <div>
                ...
                <div className="space-y-3 text-sm text-gray-600">
                  ...
                  <div className="flex items-center justify-center sm:justify-start gap-2">
                    ...
                    <span>
                      <b className="text-gray-800 underline">{followers}</b> followers,{" "}
                      <b className="text-gray-800 underline">{following}</b> following
                    </span>
                  </div>
                </div>
              </div>
